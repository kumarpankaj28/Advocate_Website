...
export default function Testi() {
  return (
    <div> 
      <h1 className="lg:text-5xl md:text-4xl text-4xl font-semibold px-4 leading-10 text-gray-800 mt-6 text-center">
      ...
      <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:px-20 px-10 py-20 gap-6">
        <div>
          <div className="group w-full bg-white relative flex flex-col items-center hover:bg-red-300 cursor-pointer shadow-md md:p-12 p-6">
